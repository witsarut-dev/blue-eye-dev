...
class CI_DB_oci8_driver extends CI_DB {
	...
	{
		/*Alert Session*/
		$stid = oci_parse($this->conn_id, "ALTER SESSION SET NLS_DATE_LANGUAGE='ENGLISH'");
		@oci_execute($stid);
		$stid = oci_parse($this->conn_id, "ALTER SESSION SET NLS_DATE_FORMAT='YYYY-MM-DD'");
		@oci_execute($stid);
		$stid = oci_parse($this->conn_id, "ALTER SESSION SET NLS_TIMESTAMP_FORMAT='YYYY-MM-DD HH24:MI:SS'");
		@oci_execute($stid);
	 ...
	 * @return  integer
	 */
	public function insert_id($module = '')
	{
		// not supported in oracle
		$stid = oci_parse($this->conn_id, "SELECT MAX(\"{$module}_id\") LAST_ID FROM \"{$module}\"");
		@oci_execute($stid);
