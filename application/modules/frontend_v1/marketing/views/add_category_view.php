<div id="CategoryData" class="container body fancybox-body">
  <div class="main_container">
    <div class="right_col" role="main">
      ...
      <div class="navbar-right"><button type="button" onclick="window.location.reload(0);" class="btn btn-success btn-round"><i class="fa fa-save"></i> Submit</button></div>
    </div>
  </div>
</div>
