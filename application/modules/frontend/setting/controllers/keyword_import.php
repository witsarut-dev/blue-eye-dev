    ...
    function cmdSaveImport()
    {
        ...
        if($row_keyword==0) {
            ...
            for ($row = 2; $row <= $highestRow; $row++) { 
                ...
                $thai_only = (isset($rowCell[1]) && $rowCell[1]=='1') ? '1' : '0';
                ...
                if($keyword_name=="") {
                    ...
                    $data = array("keyword_name"=>$keyword_name,"thai_only"=>$thai_only);
            ...
            if(@$result["status"]!==false) {
                ...
                foreach($rowsdata as $k_row=>$v_row) {
                    $post['keyword_name'] = $v_row['keyword_name'];
                    $post['thai_only']    = $v_row['thai_only'];
                    $post['status']       = "active";
