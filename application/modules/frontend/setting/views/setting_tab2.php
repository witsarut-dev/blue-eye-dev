<div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default card-view x_panel user-detail">
                <div class="panel-heading">
                    <div class="pull-left"><h6 class="panel-title txt-dark">User Detail</h6></div>
                    <div class="pull-right">
                        <a href="<?php echo site_url($module."/block_user");?>" class="btn btn-primary btn-round fancybox">Block User</a>
                        <a href="<?php echo site_url($module."/activity_log");?>" class="btn btn-primary btn-round fancybox">Activity Log</a>
                    </div>
