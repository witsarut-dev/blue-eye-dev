...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="<?php echo theme_assets_url(); ?>vendors/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo theme_assets_url(); ?>/css/font-awesome.min.css" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="<?php echo theme_assets_url(); ?>build/css/custom.min.css" rel="stylesheet">
    <link href="<?php echo theme_assets_url(); ?>css/login.css" rel="stylesheet">
  ...
  <body class="login">
    ...
    <script type="text/javascript" src="<?php echo theme_assets_url(); ?>vendors/bower_components/parsleyjs/dist/parsley.min.js"></script>
