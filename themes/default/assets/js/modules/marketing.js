...
function createChartPositive(series)
{
    $('#ChartPositive').highcharts({
        ...
        title: {
            text: '<h2 class="title" style="display:none"><span class="text-success">Positive</span></h2>',
            useHTML: true
        },
...
function createChartNegative(series)
{
    $('#ChartNegative').highcharts({
        ...
        title: {
            text: '<h2 class="title" style="display:none"><span class="text-danger">Negative</span></h2>',
            useHTML: true
        },
