...
function getPeriodTime(range)
{
    var today = new Date();
    var count = parseInt(range.substr(0, 1));
    var type  = range.substr(1, 1);
    ...
    if(range=="Today") {
        var enddate = (new Date(yy+"-"+mm+"-"+dd+" 23:59:59").getTime());
    } else {
        var enddate = (new Date(yy+"-"+mm+"-"+dd).getTime());
    }
